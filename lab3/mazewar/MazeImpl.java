...
public class MazeImpl extends Maze implements Serializable, ClientListener,
	...
	public synchronized void addClient(Client client) {
		...
		// occupied
		Point point = new Point(randomGen.nextInt(maxX),
				randomGen.nextInt(maxY));
	...
	public synchronized void addClient(Client client, Point point, Direction dir) {
		assert (client != null);
		assert (checkBounds(point));
		CellImpl cell = getCellImpl(point);
		// Direction d;
	...
	private class CellImpl extends Cell implements Serializable {
		...
		/**
		 * The contents of the {@link Cell}. <code>null</code> indicates that it
		 * is empty.
		 */
		 ...
		 * 
		 * @param contents
		 *            Object to place in the {@link Cell}. Use <code>null</code>
